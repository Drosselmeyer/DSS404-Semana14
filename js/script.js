$(document).ready(function () {
    ...
    $('#formAgregar').submit(function (e) {
        e.preventDefault();
        $.ajax({
            url: 'http://localhost/EjerciciosSemana14/php/agregar_usuario.php',
            type: 'POST',
            data: $(this).serialize(),
    ...
    $(document).on('click', '.editarUsuario', function () {
        var id = $(this).data('id');
        $.ajax({
            url: 'http://localhost/EjerciciosSemana14/php/obtener_usuarios.php',
            type: 'POST',
            data: { id: id },
            success: function (response) {
    ...
    $('#formEditar').submit(function (e) {
        ...
        var id = $('#idEditar').val();
        $.ajax({
            url: 'http://localhost/EjerciciosSemana14/php/editar_usuario.php',
            type: 'POST',
            data: $(this).serialize(),
            success: function (response) {
                cargarUsuarios();
    ...
    $(document).on('click', '.eliminarUsuario', function () {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: 'http://localhost/EjerciciosSemana14/php/eliminar_usuario.php',
                    type: 'POST',
                    data: { id: id },
                    success: function (response) {
                        cargarUsuarios();
